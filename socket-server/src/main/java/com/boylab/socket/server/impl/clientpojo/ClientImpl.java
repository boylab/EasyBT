package com.boylab.socket.server.impl.clientpojo;
...
import com.boylab.socket.server.impl.iocore.ClientIOManager;
import com.boylab.socket.common.interfaces.common_interfacies.server.IClient;
import com.boylab.socket.common.interfaces.common_interfacies.server.IClientIOCallback;
import com.boylab.socket.server.action.ClientActionDispatcher;
import com.boylab.socket.server.action.IAction;
import com.boylab.socket.server.exceptions.CacheException;
import com.boylab.socket.server.impl.OkServerOptions;
...
public class ClientImpl extends AbsClient {
    ...
    private com.boylab.socket.server.impl.iocore.ClientIOManager mIOManager;

    private IStateSender mActionDispatcher;

    private volatile com.boylab.socket.server.impl.clientpojo.ClientPoolImpl mClientPool;
