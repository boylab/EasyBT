package com.boylab.socket.client.sdk;


import com.boylab.socket.client.impl.client.ManagerHolder;
...
public class OkSocket {
    ...
    public static IConnectionManager open(String ip, int port) {
        ConnectionInfo info = new ConnectionInfo(ip);
     ...
     * @deprecated
     */
    public static IConnectionManager open(String ip, OkSocketOptions okOptions) {
        ConnectionInfo info = new ConnectionInfo(ip);
