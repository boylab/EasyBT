...
import com.boylab.socket.server.impl.clientpojo.ClientImpl;
import com.boylab.socket.server.impl.clientpojo.ClientPoolImpl;
...
import com.boylab.socket.common.interfaces.common_interfacies.server.IServerManagerPrivate;
import com.boylab.socket.server.action.IAction;
import com.boylab.socket.server.exceptions.IllegalAccessException;
...
public class ServerManagerImpl extends AbsServerRegisterProxy implements IServerManagerPrivate<OkServerOptions> {
    ...
    private com.boylab.socket.server.impl.clientpojo.ClientPoolImpl mClientPoolImpl;
    ...
    private class AcceptThread extends AbsLoopThread {
        ...
        protected void runInLoopThread() throws Exception {
            ...
            com.boylab.socket.server.impl.clientpojo.ClientImpl client = new ClientImpl(socket, mServerOptions);
